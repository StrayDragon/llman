use crate::sdd::config::{SddConfig, locale_fallbacks};
use crate::sdd::constants::LLMANSPEC_MARKERS;
use crate::sdd::regions::expand_regions;
...
fn embedded_template(path: &str) -> Option<&'static str> {
    match path {
        "templates/sdd/en/agents.md" => Some(include_str!("../../templates/sdd/en/agents.md")),
        "templates/sdd/en/agents-root-stub.md" => {
            Some(include_str!("../../templates/sdd/en/agents-root-stub.md"))
        }
        "templates/sdd/en/project.md" => Some(include_str!("../../templates/sdd/en/project.md")),
        "templates/sdd/en/spec-driven/proposal.md" => Some(include_str!(
            "../../templates/sdd/en/spec-driven/proposal.md"
        )),
        "templates/sdd/en/spec-driven/spec.md" => {
            Some(include_str!("../../templates/sdd/en/spec-driven/spec.md"))
        }
        "templates/sdd/en/spec-driven/design.md" => {
            Some(include_str!("../../templates/sdd/en/spec-driven/design.md"))
        }
        "templates/sdd/en/spec-driven/tasks.md" => {
            Some(include_str!("../../templates/sdd/en/spec-driven/tasks.md"))
        }
        "templates/sdd/en/skills/llman-sdd-onboard.md" => Some(include_str!(
            "../../templates/sdd/en/skills/llman-sdd-onboard.md"
        )),
        "templates/sdd/en/skills/llman-sdd-new-change.md" => Some(include_str!(
            "../../templates/sdd/en/skills/llman-sdd-new-change.md"
        )),
        "templates/sdd/en/skills/llman-sdd-show.md" => Some(include_str!(
            "../../templates/sdd/en/skills/llman-sdd-show.md"
        )),
        "templates/sdd/en/skills/llman-sdd-validate.md" => Some(include_str!(
            "../../templates/sdd/en/skills/llman-sdd-validate.md"
        )),
        "templates/sdd/en/skills/llman-sdd-archive.md" => Some(include_str!(
            "../../templates/sdd/en/skills/llman-sdd-archive.md"
        )),
        "templates/sdd/en/skills/shared.md" => {
            Some(include_str!("../../templates/sdd/en/skills/shared.md"))
        }
        "templates/sdd/zh-Hans/agents.md" => {
            Some(include_str!("../../templates/sdd/zh-Hans/agents.md"))
        }
        "templates/sdd/zh-Hans/agents-root-stub.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/agents-root-stub.md"
        )),
        "templates/sdd/zh-Hans/project.md" => {
            Some(include_str!("../../templates/sdd/zh-Hans/project.md"))
        }
        "templates/sdd/zh-Hans/spec-driven/proposal.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/spec-driven/proposal.md"
        )),
        "templates/sdd/zh-Hans/spec-driven/spec.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/spec-driven/spec.md"
        )),
        "templates/sdd/zh-Hans/spec-driven/design.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/spec-driven/design.md"
        )),
        "templates/sdd/zh-Hans/spec-driven/tasks.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/spec-driven/tasks.md"
        )),
        "templates/sdd/zh-Hans/skills/llman-sdd-onboard.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/skills/llman-sdd-onboard.md"
        )),
        "templates/sdd/zh-Hans/skills/llman-sdd-new-change.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/skills/llman-sdd-new-change.md"
        )),
        "templates/sdd/zh-Hans/skills/llman-sdd-show.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/skills/llman-sdd-show.md"
        )),
        "templates/sdd/zh-Hans/skills/llman-sdd-validate.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/skills/llman-sdd-validate.md"
        )),
        "templates/sdd/zh-Hans/skills/llman-sdd-archive.md" => Some(include_str!(
            "../../templates/sdd/zh-Hans/skills/llman-sdd-archive.md"
        )),
        "templates/sdd/zh-Hans/skills/shared.md" => {
            Some(include_str!("../../templates/sdd/zh-Hans/skills/shared.md"))
        }
        _ => None,
    }
}
