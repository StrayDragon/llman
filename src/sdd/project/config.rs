...
pub(crate) const LLMANSPEC_SCHEMA_URL: &str = "https://raw.githubusercontent.com/StrayDragon/llman/main/artifacts/schema/configs/en/llmanspec-config.schema.json";

/// Materialized draft-07 JSON schema for the llmanspec config document.
pub(crate) fn llmanspec_schema() -> schemars::Schema {
