...
<!-- source: OpenSpec templates/zh-Hans/opsx/sync.md (copied 2026-02-09; adapted for llman) -->
...
**输入**：可选在 `/opsx:sync` 后指定 change id（例如：`/opsx:sync add-auth`）。如果省略，请从上下文推断；如仍不明确，提示用户选择。
