...
- `llman sdd change checkpoint <id> [--no-check]` (BDD-on: clean tree + gates before archive)
...
- `llman sdd change archive <id>` (seal a change; BDD-on: docs only after checkpoint; BDD-off: merge TOON deltas)
