# language: zh-CN
# capability: tool-rm-useless-dirs
# purpose: 规范 `llman tool rm-useless-dirs` 的命令别名与无用目录清理行为。
# scope: llmanspec/specs/tool-rm-useless-dirs.feature

功能: tool-rm-useless-dirs

  @req:r37 @human
  场景: 命令别名与整棵树生效的 protected 目录
  ...
  @req:r70 @human
  场景: useless 列表移除、列表可配置、legacy 键拒绝与 gitignore 解析
