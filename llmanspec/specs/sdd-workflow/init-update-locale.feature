...
功能: SDD 初始化、指令刷新与本地化模板加载
  ...
  场景: 更新刷新指令文件保留 specs 与 changes
    ...
    当 命令执行
    而且 那么指令/模板文件被刷新
    而且 而且现有 specs 与 changes 内容保持不变
