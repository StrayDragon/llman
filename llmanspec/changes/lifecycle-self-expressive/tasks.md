...
- [ ] T7: specs-landing-contracts — 绑定分支上改写条文（sdd-workflow r93/r111/r1/r124/r137/r42 + 新升级 SOP 条；spec-format r132/r135；sdd-bdd-mode-compat r42 与 checkpoint 场景）+ 新增 @executable 场景（§10-S2 可执行项）；**在 propose/apply 的绑定分支上完成** [blocked-by: 无]
