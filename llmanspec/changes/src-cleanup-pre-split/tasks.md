...
- [ ] T1: schema-ring-untangle — config_schema 拆两块（校验工具下沉 schema_utils，llmanspec schema 生成移入 sdd::project::config），环消失；调用方改引
...
- [ ] T13: disk-hygiene-justfile — justfile 新增 clean-bdd-targets 配方
