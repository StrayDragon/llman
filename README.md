<div align="center">
  ...
  **llm**an — 集中管理 LLM 编码工具的规则（prompts）与 skills，外加 AI 编码工作流小工具
...
命令面与数据格式兼容：`llmanspec/` 目录布局（config.yaml / specs/*.feature / changes/）不变，无需任何迁移。详见 [llman-sdd](https://github.com/StrayDragon/llman-sdd)。
...
- [llmanspec/](llmanspec/) — 本仓库的活规格（`llman-sdd list --specs` 查看，工具来自 [llman-sdd v2](https://github.com/StrayDragon/llman-sdd)）
